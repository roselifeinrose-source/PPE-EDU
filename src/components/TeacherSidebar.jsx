...
import { LayoutDashboard, Gamepad2, PlusCircle, BarChart3, Users, Settings, ChevronLeft, ChevronRight } from 'lucide-react'

const NAV_ITEMS = [
  { label: 'Tableau de Bord', path: '/teacher/dashboard', icon: LayoutDashboard },
  { label: 'Mes Jeux', path: '/teacher/games', icon: Gamepad2 },
  { label: 'Créer un Jeu', path: '/teacher/create', icon: PlusCircle },
  { label: 'Analytiques', path: '/teacher/analytics', icon: BarChart3 },
  { label: 'Groupes & Élèves', path: '/teacher/groups', icon: Users },
]

export default function TeacherSidebar({ collapsed, onToggle, onSettings }) {
