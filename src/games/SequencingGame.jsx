...
import { ArrowLeft, ArrowUp, ArrowDown, GripVertical, Check, Zap, HelpCircle } from 'lucide-react'
  ...
  return (
    <div className="max-w-xl mx-auto">
      ...
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6">
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400 mb-6">Remettez les étapes dans le bon ordre (glisser-déposer ou utiliser les flèches)</p>
        <div className="space-y-2">
          {steps.map((step, i) => (
            <div
              ...
              className={`flex items-center gap-3 bg-slate-50 dark:bg-slate-900 border rounded-lg p-3 animate-in fade-in duration-200 cursor-grab active:cursor-grabbing select-none ${
                dragOverIdx === i ? 'border-indigo-400 dark:border-indigo-500 bg-indigo-50 dark:bg-indigo-900/20 scale-[1.02] shadow-md' : 'border-slate-200 dark:border-slate-700'
              }`}
            >
